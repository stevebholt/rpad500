...
- EPI provides a [helpful summary](https://www.epi.org/publication/fair-workweek-laws-helpmore-than-1-8-million-workers/) outlining the issues in employer scheduling and some policies tried elsewhere.
- New York City has [detailed information](https://www1.nyc.gov/site/dca/workers/workersrights/fastfood-retailworkers.page) about their local law governing worker schedules.
...
- Information about the initiative can be found [here](http://www.nysed.gov/curriculuminstruction/civic-readiness-initiative/).
...
- Some background on the development of the new math and reading standards can be found [here](https://blogs.edweek.org/edweek/curriculum/2017/09/NY_replaces_common_core_here_are_the_details.html).
